                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-header card-header-primary card-header-icon">
                                            ...
                                            <h3 class="card-title"><?php
                                                            ...
                                                            WHERE C.status IN ('1','4','5')
                                                            ");
                                                                    echo $pengajuan->num_rows(); ?></h3>
                                        </div>
                                        <div class="card-footer">
                                            <div class="stats">
                                                <a href="<?php echo base_url() . 'index.php/pelaksana/list_jaminan'; ?>">Selengkapnya<i class="material-icons">update</i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    INNER JOIN data_status as C
                                    ON A.id_surat = C.id_surat
                                    WHERE C.status IN ('6','7','8','9','10','11')
                                    ");
                                                                    echo $pengajuan->num_rows(); ?></h3>
                                        </div>
                                        <div class="card-footer">
