                    ...
                    <div class="card">
                        <div class="card-header card-header-tabs card-header-primary">
                            ...
                            <span style="float:right;">
                                <a href="<?php echo base_url() . 'index.php/pelaksana/detailmon/' . $s->id_surat; ?>" data-toggle="tooltip" data-placement="left" title="Lihat Laporan Realisasi" class="btn btn-sm btn-danger">MONITORING</a>
                            </span>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="card">
                                    ...
                                    <div class="nav-tabs-navigation">
                                        <div class="nav-tabs-wrapper">
                                            <ul class="nav nav-tabs" data-tabs="tabs">
                                                ...
                                                <?php $a = $s->status;
                                                    if (($a == "2" || $a == "4" || $a == "5" || $a == "6" || $a == "7" || $a == "8" || $a == "9" || $a == "10" || $a == "11")) {
                                                        echo '<li class="nav-item">
                                                        <a class="nav-link" data-toggle="collapse" href="#tabinput">
                                                            <i class="material-icons">more_vert</i>Input Surat
                                                            <div class="ripple-container"></div>
                                                        </a>
                                                    </li>';
                                                    } elseif (($a == "0")) {
                                                ...
                                                <div class="collapse" id="tabinput">
                                                    <ul class="nav">
                                                        <?php $a = $s->status;
                                                            if (($a == "3")) {
                                                                echo '';
                                                                ...
                                                                echo '<li class="nav-item">
                                                                <a class="btn btn-sm btn-rose btn-round" data-toggle="modal" data-target="#mdl_panjang">Input Perpanjangan</a>
                                                            </li>';
                                                            } ?>
                                                        <?php $a = $s->status;
                                                            if (($a == "3")) {
                                                                ...
                                                                echo '<li class="nav-item">
                                                                <a class="btn btn-sm btn-rose btn-round" data-toggle="modal" data-target="#mdl_batal">Input Pembatalan</a>
                                                            </li>';
                                                            } ?>
                                                        <?php $a = $s->status;
                                                            if (($a >= 2)) {
                                                                echo '<li class="nav-item">
                                                                <a class="btn btn-sm btn-rose btn-round" data-toggle="modal" data-target="#mdl_revisi">Revisi</a>
                                                            </li>';
                                                            } else {
                                                                echo '';
                                                            } ?>
                                                ...
                                                <?php $a = $s->status;
                                                    if (($a == "1" || $a == "20")) {
                                                        ...
                                                        <a class="nav-link" data-toggle="collapse" href="#collapseExample">
                                                            <i class="material-icons">more_vert</i>Options
                                                            <div class="ripple-container"></div>
                                                        </a>
                                                    </li>';
                                                    } else {
                                                ...
                                                <div class="collapse" id="collapseExample">
                                                    <ul class="nav">
                                                        <li class="nav-item">
                                                            <a class="btn btn-sm btn-rose btn-round" href="<?php echo base_url() . 'index.php/pelaksana/edit_jaminan/' . $s->id_surat; ?>">Ubah Data Persetujuan</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="btn btn-sm btn-rose btn-round" data-toggle="modal" data-target="#mdl_hapus">Hapus Data Persetujuan</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        ...
                                        <a href="<?php echo base_url() . 'index.php/pelaksana/list_jaminan'; ?>" data-toggle="tooltip" data-placement="left" title="Kembali" class="btn btn-sm btn-primary"> Kembali</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() . 'index.php/Pelaksana/perpanjang_act'; ?>" method="post">
                    <table class="table">
                        <tr>
...
<div class="modal fade" id="mdl_batal" tabindex="-1" role="dialog" aria-labelledby="mdl_batal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() . 'index.php/Pelaksana/pembatalan_act'; ?>" method="post">
                    <table class="table">
                        <tr>
                            <td width="35%">No. Surat</td>
...
<div class="modal fade" id="mdl_revisi" tabindex="-1" role="dialog" aria-labelledby="mdl_revisi" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() . 'index.php/Pelaksana/revisi_act'; ?>" method="post">
                    <table class="table">
                        <tr>
                            <td width="35%">No. Surat</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url() . 'index.php/pelaksana/hapus_data/' . $s->id_surat; ?>" class="btn btn-danger">Hapus</a>
            </div>
        </div>
    </div>
</div>
