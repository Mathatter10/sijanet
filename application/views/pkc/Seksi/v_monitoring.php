                    ...
                    <tbody>
                        ...
                        foreach ($data_jaminan as $s) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url() . 'index.php/seksi/detailmon/' . $s->id_surat; ?>" title="Lihat Detail" class="btn btn-primary btn-sm btn-round btn-fab"><i class="material-icons">visibility</i></a>
                                    <?php $r = $s->revisi;
                                    $p = $s->perpanjangan;
                                    if (($r == "1" || $p == "1")) {
