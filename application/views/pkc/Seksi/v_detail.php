                    ...
                    <div class="card">
                        <div class="card-header card-header-tabs card-header-primary">
                            ...
                            <span style="float:right;">
                                <a href="<?php echo base_url() . 'index.php/seksi/detailmon/' . $s->id_surat; ?>" data-toggle="tooltip" data-placement="left" title="Lihat Laporan Realisasi" class="btn btn-sm btn-danger">MONITORING</a>
                            </span>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        ...
                                        <a href="<?php echo base_url() . 'index.php/seksi/list_jaminan'; ?>" data-toggle="tooltip" data-placement="left" title="Kembali" class="btn btn-sm btn-primary"> Kembali</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() . 'index.php/seksi/perpanjang_act'; ?>" method="post">
                    <table class="table">
                        <tr>
...
<div class="modal fade" id="mdl_batal" tabindex="-1" role="dialog" aria-labelledby="mdl_batal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() . 'index.php/seksi/pembatalan_act'; ?>" method="post">
                    <table class="table">
                        <tr>
                            <td width="35%">No. Surat</td>
...
<div class="modal fade" id="mdl_revisi" tabindex="-1" role="dialog" aria-labelledby="mdl_revisi" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url() . 'index.php/seksi/revisi_act'; ?>" method="post">
                    <table class="table">
                        <tr>
                            <td width="35%">No. Surat</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url() . 'index.php/seksi/hapus_data/' . $s->id_surat; ?>" class="btn btn-danger">Hapus</a>
            </div>
        </div>
    </div>
</div>
