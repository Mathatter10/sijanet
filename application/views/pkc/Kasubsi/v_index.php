                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    ON B.id_tpb = A.id_tpb
                                    INNER JOIN bchanggar AS C
                                    ON B.id_hanggar = C.id_hanggar
                                    INNER JOIN data_status as D
                                    ON A.id_surat = D.id_surat
                                    WHERE D.status = '5' AND C.id_bc=$a
                                                            ");
                                                                    echo $pengajuan->num_rows(); ?></h3>
                                        </div>
                                        <div class="card-footer">
                                            <div class="stats">
                                                <a href="<?php echo base_url() . 'index.php/kasubsi/list_jaminan'; ?>">Selengkapnya<i class="material-icons">update</i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    INNER JOIN data_status as D
                                    ON A.id_surat = D.id_surat
                                    WHERE D.status = '11' AND C.id_bc=$a
                                    ");
                                                                    echo $pengajuan->num_rows(); ?></h3>
                                        </div>
                                        <div class="card-footer">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    INNER JOIN data_status as D
                                    ON A.id_surat = D.id_surat
                                    WHERE D.status = '16' AND C.id_bc=$a
                                    ");
                                                                    echo $pengajuan->num_rows(); ?></h3>
                                        </div>
                                        <div class="card-footer">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    INNER JOIN data_status as D
                                    ON A.id_surat = D.id_surat
                                    WHERE D.status = '0' AND C.id_bc=$a
                                    ");
                                                                    echo $pengajuan->num_rows(); ?></h3>
                                        </div>
                                        <div class="card-footer">
