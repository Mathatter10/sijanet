                    ...
                    <div class="card">
                        <div class="card-header card-header-tabs card-header-primary">
                            ...
                            <span style="float:right;">
                                <a href="<?php echo base_url() . 'index.php/kasubsi/tambah_jaminan'; ?>" data-toggle="tooltip" data-placement="left" title="Input Surat Persetujuan" class="btn btn-sm btn-danger">INPUT</a>
                            </span>
                        </div>
                        <div class="card-body">
                            ...
                            <table id="table" data-toggle="table" data-search="false" data-pagination="true" data-filter-control="true" data-filter-show-clear="true">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . 'index.php/kasubsi/detail/' . $s->id_surat; ?>" title="Lihat Detail" class="btn btn-primary btn-sm btn-round btn-fab">
