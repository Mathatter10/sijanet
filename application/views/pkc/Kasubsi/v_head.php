            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    <li class="nav-item <?php if ($this->uri->segment(2) == "") {
                        ...
                        <a class="nav-link" href="<?php echo site_url('kasubsi') ?>">
                    ...
                    <li class="nav-item <?php if ($this->uri->segment(2) == "list_jaminan") {
                        ...
                        <a class="nav-link" href="<?php echo site_url('kasubsi/list_jaminan') ?>">
                    ...
                    <li class="nav-item <?php if ($this->uri->segment(2) == "monitoring") {
                        ...
                        <a class="nav-link" href="<?php echo site_url('kasubsi/monitoring') ?>">
