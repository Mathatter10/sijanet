          ...
          <div class="card">
            <div class="card-header card-header-tabs card-header-primary">
              ...
              <span style="float:right;">
                <a href="<?php echo base_url() . 'index.php/kasubsi/detail/' . $s->id_surat; ?>" data-toggle="tooltip" data-placement="left" title="Lihat Detail Jaminan" class="btn btn-sm btn-danger">DETAIL</a>
              </span>
            </div>
            <div class="card-body">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="tab-content">
                    ...
                    <a href="<?php echo base_url() . 'index.php/kasubsi/monitoring'; ?>" data-toggle="tooltip" data-placement="left" title="Kembali" class="btn btn-sm btn-primary"> Kembali</a>
                  </div>
                </div>
              </div>
            </div>
