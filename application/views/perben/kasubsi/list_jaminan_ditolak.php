          ...
          <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="<?php echo site_url('perbenkasubsi/jaminan_ditolak/'.$s->id_surat) ?>" data-toggle="tooltip" data-placement="top" class="tip-bottom" data-original-title="Lihat" ><i class="fa fa-eye"></i></a></td>
              </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
