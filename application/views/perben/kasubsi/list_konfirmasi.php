              ...
              <tr>
                ...
                <td>
                  ...
                  <?php } elseif($s->status == '10'){
                    ?><a href="<?php echo site_url('perbenkasubsi/penelitian_lanjut/'.$s->id_surat); ?>" data-toggle="tooltip" data-placement="top" title="Penerbitan E-BPJ"><i class="fa fa-paper-plane"></i></a>
                  <?php } else {
