              ...
              <tr>
                ...
                <td>
                  ...
                  <?php } elseif($s->status == '8'){
                    ?><a href="<?php echo site_url('perbenkasubsi/penelitian_jaminan_bg/'.$s->id_surat); ?>" data-toggle="tooltip" data-placement="top" title="Teliti Jaminan"><i class="fa fa-search"></i></a>
                  <?php } elseif($s->status == '9'){
                    ?><a href="<?php echo site_url('perbenkasubsi/detail_jaminan/'.$s->id_surat); ?>" data-toggle="tooltip" data-placement="top" title="Detail"><i class="fa fa-eye"></i></a>
                  <?php } elseif($s->status == '10'){
                   ?><a href="<?php echo site_url('perbenkasubsi/lihat_jaminan_bg/'.$s->id_surat); ?>" data-toggle="tooltip" data-placement="top" title="Penerbitan E-BPJ"><i class="fa fa-paper-plane"></i></a>
