              ...
              <tr>
                ...
                <td>
                  ...
                  <?php } elseif($s->status == '8'){
                    ?><a href="<?php echo site_url('perbenkasubsi/penelitian_lanjut/'.$s->id_surat); ?>" data-toggle="tooltip" data-placement="top" title="Teliti Jaminan"><i class="fa fa-search"></i></a>
