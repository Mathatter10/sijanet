              ...
              <tr>
                ...
                <td>
                  ...
                  <!-- <?php } elseif($s->status == '6'){
                    ?><a href="<?php echo site_url('perbenkasubsi/periksa_jaminan_cb/'.$s->id_surat); ?>" data-toggle="tooltip" data-placement="top" title="Periksa Jaminan"><i class="fa fa-search"></i></a>                      
