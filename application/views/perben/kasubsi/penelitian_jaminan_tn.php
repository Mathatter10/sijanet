    ...
    <div class="row">
      <div class="card">
        ...
        <div class="card-body table-responsive">
          <form action="<?php echo site_url('perbenkasubsi/tambah_jaminan_tn_act')?>" method="post">
            <table class="table">
            ...
            <div class="tile-footer">
              ...
              <a class="btn btn-secondary" href="<?php echo site_url('perbenkasubsi/list_jaminan_tn') ?>"><i class="fa fa-fw fa-lg fa-chevron-circle-left"></i>Kembali</a>
            </div>
            <?php endforeach ;?>
          </form>
        </div>
