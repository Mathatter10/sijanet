    ...
    <div class="row">
      <div class="card">
        <div class="card-header card-header-success">
          <h4 class="card-title"><i class="material-icons">list</i>&nbsp List Jaminan Customs Bond</h4>
              ...
              <tr>
                ...
                <td>
                  ...
                  <!--<?php } elseif($s->status == '6'){
                    ?><a href="<?php echo site_url('perbenpelaksana/periksa_jaminan_cb/'.$s->id_jaminan); ?>" data-toggle="tooltip" data-placement="top" title="Periksa Jaminan"><i class="fa fa-search"></i></a>                      
