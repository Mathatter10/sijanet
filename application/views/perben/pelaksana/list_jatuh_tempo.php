          ...
          <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="<?php echo site_url('perbenpelaksana/detail_jaminan/'.$s->id_surat); ?>" class="btn btn-info btn-circle btn-sm" data-toggle="tooltip" data-placement="top" title="Detail"><i class="material-icons">info</i></a>
                </td> 
              </tr>
              <?php endforeach; ?>
            </tbody>
