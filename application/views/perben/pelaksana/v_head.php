...
<body class="">
  ...
  <div class="wrapper ">
    ...
    -->
      <div class="logo">
        <a href="<?php echo site_url('perbenpelaksana') ?>" class="simple-text logo-mini">
          <img src="<?php echo base_url('assets/images/logogram2.png')?>" style="height: 30px"/>
        </a>
        <a href="<?php echo site_url('perbenpelaksana') ?>" class="simple-text logo-normal">
      ...
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          <li class="nav-item active ">
            <a class="nav-link" href="<?php echo site_url('perbenpelaksana') ?>">
          ...
          <li class="nav-item ">
            ...
            <div class="collapse" id="pagesExamples">
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo site_url('perbenpelaksana/rekam_izin') ?>">
                    <span class="sidebar-mini"> RI </span>
                    <span class="sidebar-normal"> Rekam Izin </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo site_url('perbenpelaksana/list_rekam') ?>">
                    <span class="sidebar-mini"> RJ </span>
                    <span class="sidebar-normal"> Rekam Jaminan </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo site_url('perbenpelaksana/rekam_tools') ?>">
                    <span class="sidebar-mini"> RT </span>
                    <span class="sidebar-normal"> Rekam Tools </span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <li class="nav-item ">
            ...
            <div class="collapse" id="componentsExamples">
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo site_url('perbenpelaksana/list_jaminan_cb') ?>">
                    <span class="sidebar-mini"> CB </span>
                    <span class="sidebar-normal"> Jaminan Customs Bond </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo site_url('perbenpelaksana/list_jaminan_tn') ?>">
                    <span class="sidebar-mini"> TN </span>
                    <span class="sidebar-normal"> Jaminan Tunai </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo site_url('perbenpelaksana/list_jaminan_bg') ?>">
                    <span class="sidebar-mini"> BG </span>
                    <span class="sidebar-normal"> Bank Garansi </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo site_url('perbenpelaksana/list_jaminan_ln') ?>">
          ...
          <li class="nav-item ">
            ...
            <div class="collapse" id="formsExamples">
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo site_url('perbenpelaksana/list_ebpj') ?>">
                    <span class="sidebar-mini"> BPJ </span>
                    <span class="sidebar-normal"> Data e-BPJ </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo site_url('perbenpelaksana/list_penarikan_jaminan') ?>">
                    <span class="sidebar-mini"> PN </span>
                    <span class="sidebar-normal"> Data Penarikan </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo site_url('perbenpelaksana/list_jaminan_ditolak') ?>">
                    <span class="sidebar-mini"> TL </span>
                    <span class="sidebar-normal"> Data Penolakan </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo site_url('perbenpelaksana/list_penarikan_lain') ?>">
                    <span class="sidebar-mini"> JM </span>
                    <span class="sidebar-normal"> Data Penarikan Lainnya</span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <li class="nav-item ">
            <a class="nav-link" href="<?php echo site_url('perbenpelaksana/list_jatuh_tempo') ?>">
              <i class="material-icons">find_in_page</i>
              <p> Monitoring </p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="<?php echo site_url('perbenpelaksana/laporan') ?>">
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  <a class="dropdown-item" href="<?php echo site_url('perbenpelaksana/setting') ?>">Setting</a>
